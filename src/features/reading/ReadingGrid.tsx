...
import { Edit2, Trash2, BookOpen, Calendar, ArrowRight } from "lucide-react"
...
export function ReadingGrid({
  ...
  if (passages.length === 0) {
    return (
      <div className="w-full bg-card rounded-md border border-border p-12 text-center shadow-none">
